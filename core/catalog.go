...
var Catalog = []PackageInfo{
	...
	{Name: "export", Layer: LayerAddon, Kind: KindLibrary, Description: "CSV/XLSX export"},
	...
	{Name: "pdf", Layer: LayerAddon, Kind: KindLibrary, Description: "PDF generation helpers"},

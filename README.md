...
<p align="center">
  ...
  <a href="VERSION"><img src="https://img.shields.io/badge/version-2.0.20-green.svg" alt="Version"></a>
...
**v2.0.20** is the current line on **`main`**. Version: `2.0.20` ([`VERSION`](VERSION)).
...
| Line | Meaning |
| --- | --- |
| `v2.0.20` (`main`) | Current two-module application platform |

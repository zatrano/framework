...
<p align="center">
  ...
  <a href="VERSION"><img src="https://img.shields.io/badge/version-2.0.24-green.svg" alt="Version"></a>
...
**v2.0.24** is the current line on **`main`**. Version: `2.0.24` ([`VERSION`](VERSION)).
...
| Line | Meaning |
| --- | --- |
| `v2.0.24` (`main`) | Current two-module application platform |

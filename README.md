...
<p align="center">
  ...
  <a href="VERSION"><img src="https://img.shields.io/badge/version-2.6.0-green.svg" alt="Version"></a>
...
```bash
go install github.com/zatrano/framework/v2/cmd/zatrano@v2.6.0
zatrano new myapp
cd myapp
go mod tidy
...
**Framework `v2.6.0`** is the current public kernel. **Packages `v1.10.0`** is the current public official-packages release. Create applications with `zatrano new`. Do not clone this repository as your application.
...
| Line | Meaning |
| --- | --- |
| Framework `v2.6.0` | Current kernel / CLI / contracts |

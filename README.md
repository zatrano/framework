...
<p align="center">
  ...
  <a href="VERSION"><img src="https://img.shields.io/badge/version-2.0.15-green.svg" alt="Version"></a>
...
**v2.0.15** is the current line on **`main`**. Version: `2.0.15` ([`VERSION`](VERSION)).
...
| Line | Meaning |
| --- | --- |
| `v2.0.15` (`main`) | Current two-module application platform |

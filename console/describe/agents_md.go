...
const agentsConstitution = `## Application engineering (canonical)
...
- Web: kernel http.HTML by default; http.View after package:enable view. API: http.JSON.
...
func RenderAgentsMarkdown(doc *DescribeDocument) string {
	...
	fmt.Fprintf(&b, "Generated by `zatrano agents:generate` from `zatrano describe` (framework %s). Re-run after upgrading the framework. Do not edit the describe sections by hand.\n\n", doc.Version)
	b.WriteString("This file is an application agent brief, not a documentation site. Generated apps do **not** include a `docs/` tree; do not create one as architecture. The specification is https://zatrano.com/docs/application-engineering (Standard: https://zatrano.com/docs/application-engineering/standard).\n\n")
	b.WriteString(agentsConstitution)

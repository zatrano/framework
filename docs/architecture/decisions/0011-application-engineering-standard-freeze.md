...
Phases 0–3.5 produced ADRs 0001–0010, golden scenarios, generator alignment, `zatrano doctor`, and an adversarial enforcement boundary. Kernel, contracts, ORM, and public API were already frozen. Application architecture was still described as “evolving documentation.”
...
- Ban `app/core` and `Handler` type names (unacceptable false positives — phase 3.5).
- Reopen ADR-0001–0010 to chase fashion (Clean Architecture, HTMX, mandatory repos).
